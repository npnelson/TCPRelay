...
{
    public partial class WebSocketsServerTransport 
    {
        ...
        internal WebSocketsServerTransport(WebSocketOptions options, IDuplexPipe application,  ILoggerFactory loggerFactory)
        {
            if (options == null)
            {
